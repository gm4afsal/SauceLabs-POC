...
public class CustomReportListener implements IReporter{
	...
	private String reportTitle= "my Automation Report";
	private String reportFileName = "my_automation_report.html";
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println("<head>");
		out.println("<title>" + reportTitle + " - " + getDateAsString()  + "</title>");
